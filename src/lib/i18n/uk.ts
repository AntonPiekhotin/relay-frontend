...
export const uk: Messages = {
  ...
  chat: {
    ...
    callOutgoing: (video) => (video ? 'Вихідний відеодзвінок' : 'Вихідний дзвінок'),
    callIncoming: (video) => (video ? 'Вхідний відеодзвінок' : 'Вхідний дзвінок'),
    callMissed: (video) => (video ? 'Пропущений відеодзвінок' : 'Пропущений дзвінок'),
    callNoAnswer: (video) => (video ? 'Відеодзвінок без відповіді' : 'Дзвінок без відповіді'),
    callCanceled: (video) => (video ? 'Скасований відеодзвінок' : 'Скасований дзвінок'),
    callDeclined: (video) => (video ? 'Відхилений відеодзвінок' : 'Відхилений дзвінок'),
  },
